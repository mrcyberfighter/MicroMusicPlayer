...
static void setup_menu_item(MenuItem *menuitem, const char type, const char *label, const char *accel_label, const char *image, GtkAccelGroup *menu_files_accel_group,  GdkModifierType accel_modifier,  guint accel_key) {
...
void initialize_menu(Menu *menu) {
    ...
    setup_menu_item(menu->button_file, 'N', " Play file(s) ",   " Ctrl + F " ,    "folder-music.png", menu->accel_group, CTRL, GDK_KEY_f) ;
    ...
    setup_menu_item(menu->show_playlist, 'N', " Display playlist ", " Ctrl + Maj + P " , "applications-multimedia.png", menu->accel_group,  CTRL_SHIFT, GDK_KEY_p) ;
    ...
    setup_menu_item(menu->button_config, 'N', " Configure ", " Ctrl + C " , "preferences-system.png", menu->accel_group,  CTRL, GDK_KEY_c) ;
    ...
    setup_menu_item(menu->button_readme, 'N', " README ",    " Ctrl + R ", "document-readme.png", menu->accel_group, CTRL,  GDK_KEY_r) ;
