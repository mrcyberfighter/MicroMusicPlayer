#ifndef MICRO_MUSIC_PLAYER_SHUFFLE_HH
#define MICRO_MUSIC_PLAYER_SHUFFLE_HH
...
// Shuffle mode.
extern const int shuffle_get_song_index() ;

extern bool is_end_of_shuffle_playlist() ;

extern void shuffle_playlist() ;
