...
extern void repeat_all_feature_set(GtkToggleButton *togglebutton, int *is_repeating_all) ;
...
extern void set_volume(GtkRange *range, gpointer user_data) ;

extern void switch_minimal_normal_interface(GtkWidget *widget, gpointer user_data) ;


extern void configure_theme_light(GtkWidget *widget, gpointer *user_data) ;

extern void configure_theme_dark(GtkWidget *widget, gpointer *user_data) ;


extern void switch_to_light_theme_menu(GtkWidget *widget, gpointer g_ptr) ;

extern void switch_to_dark_theme_menu(GtkWidget *widget, gpointer g_ptr) ;
