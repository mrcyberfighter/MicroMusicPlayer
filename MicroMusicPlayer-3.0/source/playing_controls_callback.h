#ifndef MICRO_MUSIC_PLAYER_CONTROLS_HH
...
// Extra features.
extern void repeat_all_music(GtkWidget *button, gpointer user_data) ;
extern void shuffle_music(GtkWidget *button, gpointer user_data) ;
extern void menu_shuffle_music(GtkCheckMenuItem *menuitem, gpointer user_data) ;

// Menu items callback.
extern void menu_repeat_all_music(GtkCheckMenuItem *togglebutton, gpointer user_data) ;
extern void menu_repeat_off_music(GtkCheckMenuItem *menuitem, gpointer user_data)     ;
extern void menu_repeat_one_music(GtkCheckMenuItem *menuitem, gpointer user_data)     ;



// Volume changing callback.
extern void change_volume(GtkScaleButton *button, gdouble value, gpointer user_data) ;
extern void increment_volume(GtkWidget *widget, gpointer user_data) ;
extern void decrement_volume(GtkWidget *widget, gpointer user_data) ;
