#ifndef MICRO_MUSIC_PLAYER_VIEW_PLAYLIST_HH
#define MICRO_MUSIC_PLAYER_VIEW_PLAYLIST_HH
...
extern void build_playlist(GtkWidget *widget, gpointer user_data) ;

extern void change_playlist(void) ;
